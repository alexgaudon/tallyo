  ...
  return (
    <Dialog {...props}>
      ...
      <DialogContent
        ...
        // The command input row is 48px tall; centre the close button in it
        // rather than the dialog's default top-4 offset.
  ...
  return (
    ...
    >
      ...
      <CommandPrimitive.Input
        ...
        className={cn(
          "placeholder:text-muted-foreground flex h-10 w-full rounded-md bg-transparent py-3 text-base md:text-sm outline-hidden disabled:cursor-not-allowed disabled:opacity-50 focus-visible:ring-0 focus-visible:ring-offset-0 focus:outline-none focus:ring-0 focus:border-transparent",
          className
        )}
        {...props}
      />
