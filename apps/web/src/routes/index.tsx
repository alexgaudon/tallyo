							...
							<Stats
								data={{
									stats: {
										...
										totalIncomeTransactions: 12,
										totalExpenseTransactions: 36,
										avgIncomeTransactionsPerMonth: 8,
										avgExpenseTransactionsPerMonth: 24,
										avgIncomeAmountPerMonth: 27458,
										avgExpenseAmountPerMonth: 14965,
