...
const DateInput: React.FC<DateInputProps> = ({ value, onChange, disabled = false }) => {
  ...
  return (
    <div className="flex items-center px-1 border rounded-lg text-sm">
      <input
        ...
        className="bg-background p-0 border-none w-6 text-center text-foreground outline-hidden"
        placeholder="M"
      />
      ...
      <input
        ...
        className="bg-background p-0 border-none w-7 text-center text-foreground outline-hidden"
        placeholder="D"
      />
      <span className="opacity-20 -mx-px">/</span>
      <input
        ...
        className="bg-background p-0 border-none w-12 text-center text-foreground outline-hidden"
        placeholder="YYYY"
      />
    </div>
  );
