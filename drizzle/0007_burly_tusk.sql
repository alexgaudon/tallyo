ALTER TABLE `transaction` RENAME COLUMN "vendor_raw" TO "display_vendor";--> statement-breakpoint
...
ALTER TABLE `transaction` ALTER COLUMN "display_vendor" TO "display_vendor" text;--> statement-breakpoint
...
ALTER TABLE `transaction` ALTER COLUMN "vendor" TO "vendor" text NOT NULL;